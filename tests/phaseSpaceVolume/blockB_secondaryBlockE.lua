...
-- First |P|: only one input to the secondary block is concerned
...
Looper.looperSBE = {
    solutions = 'secBlockE::solutions',
    path = Path('sum_SBE', 'blockb', 'looperB')
}

-- Loop for secondary block

    VectorLinearCombinator.sum_SBE = {
        coefficients = { 1., 1., 1. },
        inputs = { 'looperSBE::particles/1', 'looperSBE::particles/2', inputs[3] }
    }
    ...
    -- Loop for main block
        ...
        full_inputs = { 'looperB::particles/1', 'looperSBE::particles/1', 'looperSBE::particles/2', inputs[3] }
        ...
        jacobians = {
          ...
          'flatter_s12::jacobian', 'flatter_s123::jacobian', 'flatter_sB::jacobian', 'looperSBE::jacobian', 'looperB::jacobian', 'phaseSpaceOut::phase_space'
        }
