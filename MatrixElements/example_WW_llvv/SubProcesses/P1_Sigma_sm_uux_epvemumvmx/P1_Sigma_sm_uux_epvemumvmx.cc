...
P1_Sigma_sm_uux_epvemumvmx::P1_Sigma_sm_uux_epvemumvmx(ParameterSet&
    configuration)
{
...
REGISTER_MATRIX_ELEMENT("example_WW_llvv_P1_Sigma_sm_uux_epvemumvmx",
    P1_Sigma_sm_uux_epvemumvmx)
}
