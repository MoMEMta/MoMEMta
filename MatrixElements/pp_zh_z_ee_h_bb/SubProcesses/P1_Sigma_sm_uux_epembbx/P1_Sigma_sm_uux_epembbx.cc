...
#include <P1_Sigma_sm_uux_epembbx.h> 
...
P1_Sigma_sm_uux_epembbx::P1_Sigma_sm_uux_epembbx(const ParameterSet&
    configuration)
{
  ...
  {
    {
      &P1_Sigma_sm_uux_epembbx::matrix_1_uux_zh_z_epem_h_bbx, 
      true, 
      {
    ...
    , 
    {
      &P1_Sigma_sm_uux_epembbx::matrix_1_ddx_zh_z_epem_h_bbx, 
      true, 
      {
...
std::map < std::pair < int, int > , double >
    P1_Sigma_sm_uux_epembbx::compute(const std::pair < std::vector<double> ,
...
void P1_Sigma_sm_uux_epembbx::calculate_wavefunctions(const int perm[], const
    int hel[])
{
  // Calculate wavefunctions for all processes
  static std::complex<double> w[10][18]; 
  ...
  FFS4_3(w[6], w[5], params->GC_83, params->mdl_MH, params->mdl_WH, w[7]); 
  ...
  VVS1_0(w[4], w[8], w[7], params->GC_81, amp[0]); 
  VVS1_0(w[4], w[9], w[7], params->GC_81, amp[1]); 

}
double P1_Sigma_sm_uux_epembbx::matrix_1_uux_zh_z_epem_h_bbx() 
{
...
double P1_Sigma_sm_uux_epembbx::matrix_1_ddx_zh_z_epem_h_bbx() 
{
...
REGISTER_MATRIX_ELEMENT("pp_zh_z_ee_h_bb_sm",
    pp_zh_z_ee_h_bb_sm::P1_Sigma_sm_uux_epembbx);
