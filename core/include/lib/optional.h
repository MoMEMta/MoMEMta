...
//       } else {
//          ...
//          return momemta::gtl::nullopt;
//       }
//     }
//
//     int main() {
//         momemta::gtl::optional<string> optstr = f();
//         if (optstr) {
//            // non-empty
//            print(optstr.value());
//         } else {
...
template <class T>
struct hash<::momemta::gtl::optional<T>> {
  size_t operator()(const ::momemta::gtl::optional<T>& opt) const {
    if (opt) {
      return hash<T>()(*opt);
    } else {
