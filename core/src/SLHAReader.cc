...
double SLHABlock::get_entry(vector<int> indices, double def_val) const
{
				   ...
				   double def_val) const
{
  ...
  return _blocks.at(block_name).get_entry(indices);  
}
