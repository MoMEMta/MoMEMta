...
class Module {
    public:
         ...
         */
        virtual Status work(bool save_values = false) { return Status::OK; };
        ...
        virtual void store_solutions() {};

        virtual std::vector<SolutionCollection> get_block_solutions()  const final {
    ...
    protected:
        ...
        /**
         * \brief Vector where all solutions generated by a Block will be stored and accessible later.
         */
        std::vector<SolutionCollection> block_solutions {};
